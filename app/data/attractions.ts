...
export const attractions: Attraction[] = [
  {
    ...
    category: '세계문화유산',
    description:
      '신라시대에 건립된 국보급 사찰로, 유네스코 세계문화유산에 등재된 경주의 대표 명소입니다. 다보탑과 석가탑 등 국보급 문화재를 품고 있습니다.',
  ...
  },
  {
    ...
    category: '세계문화유산',
    description:
      '토함산 중턱에 위치한 국보 제24호. 8세기 통일신라 시대에 만들어진 화강암 석굴 사원으로 본존불의 웅장함이 압도적입니다.',
  ...
  },
  {
    ...
    category: '역사유적',
    description:
      '7세기 선덕여왕 때 건립된 동양에서 가장 오래된 천문대. 362개의 돌로 쌓인 원통형 건물로 신라의 과학 수준을 엿볼 수 있습니다.',
  ...
  },
  {
    ...
    category: '역사유적',
    description:
      '통일신라시대의 별궁과 인공 연못. 야경이 특히 아름다워 경주 야경 명소 1위로 손꼽힙니다. 발굴된 유물들은 국립경주박물관에서 볼 수 있습니다.',
  ...
  },
  {
    ...
    category: '박물관',
    description:
      '신라 천년의 유물을 한자리에서 볼 수 있는 국립박물관. 성덕대왕 신종(에밀레종), 금관, 토우 등 귀중한 문화재를 소장하고 있습니다.',
  ...
  },
  {
    ...
    category: '카페·쇼핑',
    description:
      '경주 도심의 핫플레이스. 한옥을 개조한 카페, 음식점, 소품숍이 즐비한 거리로 젊은 여행객들에게 특히 인기입니다.',
  ...
  },
  {
    ...
    category: '역사유적',
    description:
      '신라 왕과 귀족들의 무덤이 모인 광대한 고분군. 천마총 내부를 공개하고 있어 신라 왕릉의 구조를 직접 확인할 수 있습니다.',
  ...
  },
  {
    ...
    category: '전통마을',
    description:
      '조선시대 경주 향교를 중심으로 형성된 전통 한옥마을. 최부자댁, 경주 향교, 교촌한옥체험마을이 모여 있는 역사 문화 공간입니다.',
